...
class SettingsDialog(QDialog):
    ...
    def update_transparency(self, trans_key, value):
        ...
        # Update the label
        if trans_key == "background_transparency":
            if hasattr(self, "bg_trans_value"):
                self.bg_trans_value.setText(f"{value}%")
        elif trans_key == "button_transparency":
            if hasattr(self, "btn_trans_value"):
                self.btn_trans_value.setText(f"{value}%")
        else:
